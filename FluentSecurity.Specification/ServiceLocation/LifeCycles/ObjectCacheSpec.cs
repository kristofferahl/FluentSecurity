...
namespace FluentSecurity.Specification.ServiceLocation.LifeCycles
{
	...
	public class When_setting_an_object_in_the_ObjectCache
	{
		...
		[Test]
		public void Should_not_throw_when_key_is_not_unique()
		{
			// Arrange
			var key = Guid.NewGuid();
			var objectCache = new ObjectCache();
			...
			// Act & assert
			Assert.DoesNotThrow(() => objectCache.Set(key, obj1));
		}
	...
	[TestFixture]
	[Category("ObjectCacheSpec")]
	public class When_adding_an_object_in_the_ObjectCache
	{
		[Test]
		public void Should_not_add_to_cache_when_instance_is_null()
		{
		...
		[Test]
		public void Should_throw_when_key_is_not_unique_using()
		{
			// Arrange
			var key = Guid.NewGuid();
			var objectCache = new ObjectCache();
			...
			objectCache.Add(key, obj1);

			// Act & assert
			Assert.Throws<ArgumentException>(() => objectCache.Add(key, obj2));
		}
		...
		public void Should_dispose_IDisposable_instances_when_cleared()
		{
			...
			var objectCache = new ObjectCache();
			objectCache.Add(key, disposable.Object);
