...
{
	[TestFixture]
	[Category("RequireAnyRolePolicySpec")]
	public class When_passing_null_to_the_constructor_of_RequireAnyRolePolicy
	{
		[Test]
	...
	[TestFixture]
	[Category("RequireAnyRolePolicySpec")]
	public class When_passing_an_empty_array_to_the_constructor_of_RequireAnyRolePolicy
	{
		[Test]
	...
	[TestFixture]
	[Category("RequireAnyRolePolicySpec")]
	public class When_passing_an_array_with_one_required_role_to_the_constructor_of_RequireAnyRolePolicy
	{
		[Test]
	...
	[TestFixture]
	[Category("RequireAnyRolePolicySpec")]
	public class When_getting_the_required_roles_for_a_RequireAnyRolePolicy
	{
		[Test]
	...
	[TestFixture]
	[Category("RequireAnyRolePolicySpec")]
	public class When_enforcing_security_for_a_RequireAnyRolePolicy
	{
		[Test]
	...
	public class When_doing_tostring_for_a_RequireAnyRolePolicy
	{
		[Test]
	...
	[TestFixture]
	[Category("RequireAnyRolePolicySpec")]
	public class When_comparing_RequireAnyRolePolicy
	{
		[Test]
	...
	[TestFixture]
	[Category("RequireAnyRolePolicySpec")]
	public class When_getting_the_hash_code_for_RequireAnyRolePolicy
	{
		[Test]
